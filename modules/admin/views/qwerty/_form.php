...
<?php
$dir = 'images/authors/smallqwerty';
$files1 = scandir($dir);
$count = 0;
?>
...
<img src="/images/authors/smallqwerty/<?= $value ?>" width="100px">
<br>
...
<?php endforeach; ?>
<?php if($count == 0): ?>
<span style="color:red">В папку smallqwerty не загружены изображения</span>
<?php endif; ?>
<hr>
...
<?php if(preg_match($qw, $value)): ?>
<div style="display: inline-block; border: 1px solid #ccc; margin: 20px; padding: 10px;">
<img src="/images/authors/qwerty/<?= $value ?>" width="100px">
<br>
<span style="margin: 10px 0; display: inline-block;">
	/images/authors/qwerty/<?= $value ?>
</span>
</div>
<?php endif; ?>
<?php endif; ?>
...
<?php endif; ?>
<?php if($count1 == 0): ?>
<span style="color:red">В папку qwerty не загружены изображения</span>
<?php endif; ?>
