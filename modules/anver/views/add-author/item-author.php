...
?>
<h1 style="font-size: 28px;margin-bottom: 10px;">anver/item-author</h1>
<span style="font-size: 32px;color: red;">8</span>
<hr>
<?php
$filename = '../views/' . $small . '/_item_author.php';
?>
...
<a href=\"<?= Url::to(['$small/article', 'id' => Html::encode(\$model->id)]);?>\" style=\"margin-bottom: 60px;\">
<?php
...
<img src=\"/images/authors/small$small/<?= trim(Html::encode(\$model->img_small)); ?>\">
