...
<a href="<?= Url::to(['ksyusha-delaet/article', 'id' => Html::encode($model->id)]);?>" style="margin-bottom: 60px;">
<?php
...
<img src="/images/authors/smallksyusha-delaet/<?= trim(Html::encode($model->img_small)); ?>">
