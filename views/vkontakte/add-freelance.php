  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Отправить модератору</h4>
      </div>
      <div class="modal-body">
<?php
use app\models\AddFreelanceForm;
$add = new AddFreelanceForm();
?>
...
<?php
if(isset($_POST['AddFreelanceForm'])) {

$telephone1=htmlspecialchars($_POST['AddFreelanceForm']['url']);
